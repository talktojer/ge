#!/bin/bash
# Phase C3a Smoke Test
# Demonstrates command→event→WebSocket delta flow
...
echo "======================================"
echo "Phase C3a Smoke Test"
echo "======================================"
echo ""

# Step 1: Get session token
echo "[1/4] Getting session token for player_1..."
...
# Step 2: Move command
echo "[2/4] Issuing move command (ship 201: 5,5 → 6,5)..."
...
# Step 3: Fire command
echo "[3/4] Issuing fire command (ship 201 → target 202, phasor)..."
...
# Step 4: Claim command (planet 102 is unowned)
echo "[4/4] Issuing claim command (ship 201 → planet 102)..."
...
echo "Verifying planet 102 is now owned by player_1..."
...
if [ "$PLANET_102_OWNER" = "$PLAYER_ID" ]; then
  echo "✅ Planet 102 ownership verified (in-memory state updated)"
else
...
echo "======================================"
echo "✅ Phase C3a Smoke Test PASSED"
echo "======================================"
echo ""
echo "All commands published events to Redis."
